...
import 'package:sedapps_mobile/src/widgets/animations.dart';
import 'package:sedapps_mobile/src/widgets/dialogs.dart';
import 'package:sedapps_mobile/src/widgets/notifications.dart';
...
void main() {
  ...
  group('Dialogs Tests', () {
    testWidgets('ConfirmDialog displays correctly',
    ...
    testWidgets('SuccessDialog displays correctly',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
