...
final mockJob = {
  ...
  'input': {
    ...
    'brief': 'Agence spécialisée en création de sites web modernes et responsifs',
  },
  'output': {
  ...
  'agents': [
    ...
    },
    {
      ...
      'tokens_in': 380,
      'tokens_out': 920,
      'input': {'business_name': 'Mon Agence Web', 'sector': 'Services numériques'},
      'output': {
    ...
    },
    {
      ...
      'tokens_in': 420,
      'tokens_out': 650,
      'input': {'business_name': 'Mon Agence Web', 'keywords': ['agence web', 'création site', 'web design']},
      'output': {
        'meta_title': 'Agence Web Professionnelle | Création de Sites Modernes',
        'meta_description': 'Créez votre site web avec notre agence spécialisée en design et développement web.',
    ...
    },
    {
      ...
      'tokens_in': 580,
      'tokens_out': 1200,
      'input': {'design_tokens': {'primary': '#5B5CF6'}, 'sections': ['hero', 'features', 'cta']},
      'output': {
