...
String _friendlyAgentMessage(String name) {
  const map = {
    ...
    'copywriter': 'Rédaction des textes personnalisés…',
    'seo': 'Optimisation pour les moteurs de recherche…',
    'form_builder': 'Mise en place des formulaires…',
    'cms_builder': 'Organisation de votre contenu…',
    'site_planner': 'Planification de l\'architecture…',
    'static_page_builder': 'Construction des pages web…',
    'static_frontend_builder': 'Génération du site web…',
    ...
    'ux_architect': 'Optimisation de l\'expérience…',
    'premium_qa': 'Contrôle qualité avancé…',
    'refinement_agent': 'Finalisation et polish…',
    'qa': 'Vérification qualité…',
    'frontend_builder': 'Construction de l\'interface…',
    'frontend_generator': 'Génération des composants…',
    'blog_writer': 'Rédaction des articles…',
  };
  return map[name] ?? 'Votre site est en cours de création…';
}
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return projectAsync.when(
      data: (project) {
        ...
        final projectName = project['name']?.toString() ?? 'Votre site';

        // Message de progression
        String progressMessage = 'Votre site est en cours de création…';
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  ...
                  Color.lerp(const Color(0xFF5B21B6), const Color(0xFF7C3AED), glow)!,
                ],
              ),
