            ...
            if (snapshot.hasError) {
              return Card(
                child: Padding(
                  ...
                  child: Text(
                      'Impossible de charger le compte : ${snapshot.error}',
              ...
              child: Column(
                ...
                children: [
                  ...
                  _SettingItem(
                    ...
                    onTap: () => NotificationService.info(context,
                        'Modification de l’organisation bientôt disponible'),
                  ),
                  _SettingItem(
                    ...
                    onTap: () => NotificationService.info(
                        context, 'Redirection vers la facturation...'),
                  ),
                  _SettingItem(
                    icon: Icons.language,
                  ...
                  _SettingItem(
                    ...
                    value: 'Email actif',
                    onTap: () => NotificationService.info(
                        context, 'Préférences de notifications'),
                  ),
                  _SettingItem(
                    icon: Icons.security,
                    ...
                    onTap: () => NotificationService.info(
                        context, 'Paramètres de sécurité'),
                  ),
                ],
              ),
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  _PreferenceItem(
                      ...
                      value: 'Français',
                      onTap: () => NotificationService.info(
                          context, 'Changement de langue')),
                  _PreferenceItem(
                      label: 'Thème',
                      value: 'Clair',
                      onTap: () => NotificationService.info(
                          context, 'Changement de thème')),
                  _PreferenceItem(
                      label: 'Fuseau horaire',
                      value: 'Europe/Paris',
                      onTap: () => NotificationService.info(
                          context, 'Changement de fuseau horaire')),
                ],
              ),
            ),
          ),
