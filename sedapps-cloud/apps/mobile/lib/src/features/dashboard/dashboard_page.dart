                    ...
                    child: Center(
                      child: Column(
                        children: [
                          ...
                          const Text('Crée ton premier site avec l\'IA.',
        ...
        child: Column(
          ...
          children: [
            ...
            _ActionTile(
                ...
                color: AppColors.skyBlue,
                title: 'Nouveau site',
                desc: 'Lance la création IA',
                onTap: () => context.go('/new-site')),
            _ActionTile(
                icon: Icons.article_outlined,
                color: const Color(0xFFF59E0B),
                title: 'Nouvel article',
                desc: 'Rédige du contenu SEO',
                onTap: () => context.go('/cms')),
            _ActionTile(
                icon: Icons.cloud_upload_outlined,
                color: const Color(0xFF10B981),
                title: 'Publier un site',
                desc: 'Déploie sur OVH',
                onTap: () {}),
            _ActionTile(
                icon: Icons.analytics_outlined,
                color: const Color(0xFF6366F1),
                title: 'Voir analytics',
                desc: 'Stats visiteurs',
                onTap: () {}),
          ],
        ),
      ),
