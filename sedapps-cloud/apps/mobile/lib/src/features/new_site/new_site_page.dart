        ...
        child: Column(
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                hintText:
                    'Décris ce que tu vends, à qui, avec quel style, tes objectifs...',
            ...
            if (loading)
              Column(
                children: const [
                  ...
                  SizedBox(height: 12),
                  Text(
                      'Création en cours... Nos agents travaillent sur ton site.',
                      style: TextStyle(
            ...
            FilledButton.icon(
              ...
              label: Text(
                  loading ? 'Création en cours...' : 'Lancer la création IA'),
