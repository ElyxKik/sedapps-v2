    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: const Text(
              'Cette action est définitive. Le projet, ses contenus et ses tâches associées seront supprimés.'),
          actions: [
            TextButton(
...
enum _WorkspacePanel {
  chat(
    ...
    subtitle: 'Actions rapides ou demandes personnalisées à l\'IA.',
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        projectName != null ? 'Espace projet - $projectName' : 'Espace projet',
