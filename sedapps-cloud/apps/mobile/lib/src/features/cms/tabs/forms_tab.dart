            ...
            child: Column(
              ...
              children: [
                const SectionHeader(
                    ...
                    subtitle: 'Dernières demandes reçues'),
      ...
      child: Row(
        children: [
          Container(
            ...
            child:
                const Icon(Icons.dynamic_form, color: Colors.white, size: 22),
          ),
                  ...
                  children: [
                    ...
                    Row(mainAxisSize: MainAxisSize.min, children: [
                      Icon(Icons.send,
                          size: 12, color: AppColors.textSecondary),
                      const SizedBox(width: 4),
                      Text('${form['submissions']} soumissions',
                          style: const TextStyle(
                              color: AppColors.textSecondary, fontSize: 12)),
                    ]),
                  ],
      ...
      child: Row(
        children: [
          CircleAvatar(
            ...
            child: Text(initial,
                style: const TextStyle(
                    color: AppColors.skyBlueDark, fontWeight: FontWeight.w700)),
          ),
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(submission['name'] as String,
                    style: const TextStyle(
                        fontWeight: FontWeight.w600, fontSize: 13)),
                Text(submission['email'] as String,
                    style: const TextStyle(
                        color: AppColors.textSecondary, fontSize: 12)),
              ],
            ),
