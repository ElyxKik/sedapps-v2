          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: AppColors.skyBlue.withValues(alpha: 0.3), style: BorderStyle.solid, width: 2),
                borderRadius: BorderRadius.circular(14),
              ),
              child: Column(
                children: [
                  const Icon(Icons.cloud_upload_outlined, color: AppColors.skyBlue, size: 40),
                  const SizedBox(height: 8),
                  const Text('Glisse tes fichiers ici', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
            ...
            LayoutBuilder(
              builder: (context, constraints) {
                ...
                return GridView.builder(
                  ...
                  itemBuilder: (context, index) => _MediaCard(media: _media[index]),
                );
              },
            ),
          ],
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(media['size'] as String, style: const TextStyle(fontSize: 10, color: AppColors.textSecondary)),
              ],
            ),
          ),
        ],
