            ...
            onPressed: projectId == null
                ...
                : () async {
                    try {
                      ...
                      if (context.mounted)
                        NotificationService.error(
                            context, 'Téléchargement indisponible : $error');
                    }
                  },
                ...
                : () async {
                    ...
                    if (context.mounted)
                      NotificationService.success(
                          context, 'Site publié avec succès');
                  },
            icon: isPublishing
                ? const SizedBox(
                    width: 16,
            ...
            child: Column(
              ...
              children: [
                ...
                SwitchListTile(
                  ...
                  onChanged: (value) => ref
                      .read(projectWorkspaceProvider.notifier)
                      .updatePublish(subdomainEnabled: value),
                ...
                SwitchListTile(
                  ...
                  onChanged: (value) => ref
                      .read(projectWorkspaceProvider.notifier)
                      .updatePublish(customDomainEnabled: value),
                ...
                TextField(
                  ...
                  decoration: const InputDecoration(
                      labelText: 'Domaine de publication',
                      prefixIcon: Icon(Icons.language)),
                  onSubmitted: (value) => ref
                      .read(projectWorkspaceProvider.notifier)
                      .updatePublish(domain: value),
                ),
                const Divider(),
                _DeployStep(
                    title: 'Build statique Next.js',
                    ready: publish.status != 'draft',
                    active: publish.status == 'building'),
                _DeployStep(
                    title: 'Upload OVH Object Storage',
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                            child: Text('Site disponible : ${publish.url}',
