      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 12),
            Text('Aperçu indisponible', style: TextStyle(fontWeight: FontWeight.w700)),
            SizedBox(height: 6),
            Text(
      ...
      child: Row(
        children: [
          SegmentedButton<PreviewDevice>(
            segments: const [
              ButtonSegment(value: PreviewDevice.desktop, icon: Icon(Icons.desktop_mac), label: Text('Desktop')),
              ButtonSegment(value: PreviewDevice.tablet, icon: Icon(Icons.tablet_mac), label: Text('Tablet')),
              ButtonSegment(value: PreviewDevice.mobile, icon: Icon(Icons.phone_iphone), label: Text('Mobile')),
            ],
            selected: {device},
          ...
          IconButton(onPressed: onRefresh, icon: const Icon(Icons.refresh), tooltip: 'Rafraîchir'),
          IconButton(onPressed: onOpen, icon: const Icon(Icons.open_in_new), tooltip: 'Ouvrir'),
        ],
      ),
    );
  }
