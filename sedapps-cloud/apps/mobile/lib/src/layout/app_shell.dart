...
const _items = <_NavItem>[
  _NavItem('Dashboard', Icons.space_dashboard_outlined, Icons.space_dashboard_rounded, '/'),
  _NavItem('Projets', Icons.folder_outlined, Icons.folder_rounded, '/projects'),
  _NavItem('Nouveau', Icons.add_circle_outline, Icons.add_circle_rounded, '/new-site'),
  _NavItem('CMS', Icons.article_outlined, Icons.article_rounded, '/cms'),
  _NavItem('Compte', Icons.person_outline, Icons.person_rounded, '/account'),
];
...
class _AppShellState extends State<AppShell> {
  ...
  int _selectedIndex(String loc) {
    for (var i = _items.length - 1; i >= 0; i--) {
      if (loc == _items[i].path || loc.startsWith('${_items[i].path}/')) return i;
    }
    return 0;
  }
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                if (expanded) const Flexible(child: _Logo()) else const _LogoMark(),
                if (expanded)
                  _IconBadge(
          ...
          const Divider(height: 1),
          Padding(
            padding: EdgeInsets.fromLTRB(expanded ? 14 : 8, 14, expanded ? 14 : 8, 18),
            child: expanded
                ? Row(
                    children: [
                      const _Avatar(),
    ...
    final content = AnimatedContainer(
      ...
      child: Row(
        ...
        children: [
          ...
          Icon(selected ? widget.item.selectedIcon : widget.item.icon, color: fg, size: 20),
          if (widget.expanded) ...[
