...
class OrchestratorClient:
    ...
    async def enqueue_site_generation(self, *, job_id: str, project_id: str, tenant_id: str,
                                       brief: dict, locale: str = "fr") -> None:
    ...
    async def enqueue_article_generation(self, *, job_id: str, project_id: str, tenant_id: str,
                                          params: dict) -> None:
        async with httpx.AsyncClient(timeout=10.0) as c:
            r = await c.post(
