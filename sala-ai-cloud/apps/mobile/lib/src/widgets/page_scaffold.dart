...
class PageScaffold extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final hasActiveJob = ref.watch(currentJobIdProvider) != null &&
        ref.watch(currentJobProjectIdProvider) != null;
    return ListView(
      ...
      children: [
        ...
        if (hasActiveJob) const ActiveJobBanner(),
        ...children,
      ],
    );
  }
              ...
              children: [
                ...
                FittedBox(
                  ...
                  child: Text(
                    ...
                    style: Theme.of(context)
                        .textTheme
                        .displayMedium
                        ?.copyWith(fontSize: valueSize, height: 1.1),
                  ),
                ),
                ...
                Text(
                  ...
                  style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                      color: AppColors.textSecondary, fontSize: labelSize),
                ),
              ],
            ),
          ),
      ...
      child: Stack(
        children: [
          Positioned(
            ...
            top: -20,
            child: Icon(icon,
                size: 160, color: Colors.white.withValues(alpha: 0.08)),
          ),
          Row(
            children: [
              Expanded(
