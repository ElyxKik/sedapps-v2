...
class ProjectWorkspaceNotifier extends StateNotifier<ProjectWorkspaceState> {
          ...
          const ProjectWorkspaceState(
            ...
            messages: [
              ChatMessage(
                role: 'assistant',
                text:
                    'Bienvenue ! Je suis le Générateur IA Sala AI. Demande-moi de modifier ton site, créer un article CMS, ajuster les couleurs, préparer un déploiement…',
  ...
  Future<void> askAi(String text) async {
    ...
    try {
      ...
      responseText = 'Une erreur est survenue. Réessaie dans un instant.';
      isError = true;
    }
