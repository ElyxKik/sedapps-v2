...
class BlogTab extends StatelessWidget {
  ...
  static const _articles = [
    {
      'title': 'Les tendances du web design 2026',
      'status': 'published',
      'date': '15 mars',
      'views': '1.2k',
      'comments': 8
    ...
    {
      'title': 'SEO en 2026 : ce qui change vraiment',
      'status': 'published',
      'date': '08 mars',
      'views': '3.4k',
      'comments': 24
    ...
    {
      'title': 'Comment l\'IA transforme le no-code',
      'status': 'review',
      'date': '05 mars',
      'views': '0',
      'comments': 0
    ...
    {
      'title': 'Optimiser ses Core Web Vitals',
      'status': 'published',
      'date': '02 mars',
      'views': '892',
      'comments': 5
...
class _FilterChip extends StatelessWidget {
  const _FilterChip(
      {required this.label, required this.count, this.selected = false});
  final String label;
  final int count;
  final bool selected;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border:
            Border.all(color: selected ? AppColors.skyBlue : AppColors.border),
      ),
      child: Row(
      ...
      child: Row(
        children: [
          ...
          IconButton(
              ...
              onPressed: () {}),
          IconButton(
              icon: const Icon(Icons.more_horiz, size: 18), onPressed: () {}),
        ],
      ),
    );
  }
