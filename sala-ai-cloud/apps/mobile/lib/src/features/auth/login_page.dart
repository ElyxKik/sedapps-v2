        ...
        children: [
          Positioned(
            ...
            child: Icon(Icons.cloud,
                size: 320, color: Colors.white.withValues(alpha: 0.08)),
          ),
          Positioned(
            left: -30,
            bottom: -30,
            child: Icon(Icons.auto_awesome,
                size: 240, color: Colors.white.withValues(alpha: 0.08)),
          ),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Spacer(),
                const Text('Crée ton site professionnel en quelques minutes.',
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 42,
                        fontWeight: FontWeight.w800,
                ...
                Text(
                    'Sala AI crée ton site de A à Z : textes, design, pages. Choisis ton adresse personnelle (ex : monsite.fr) et mets-le en ligne en un clic.',
                    style: TextStyle(
      ...
      child: ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(registering ? 'Créer un compte' : 'Bon retour',
                  style: Theme.of(context).textTheme.headlineLarge),
              const SizedBox(height: 8),
              Text(
                  registering
                      ? 'Démarre ton espace Sala AI en quelques secondes.'
                      : 'Connecte-toi à ton espace Sala AI.',
              ...
              FilledButton(
                ...
                child: loading
                    ...
                    : Text(registering ? 'Créer mon compte' : 'Se connecter',
